...
<PagerStyle CssClass="pgr"></PagerStyle>
    ...
    <div class="fila col10L">
                <center><asp:Button class="botonsubmit no-print" value="REGISTRAR CLIENTE" type="submit"  runat="server" CssClass="botonsubmit no-print"  OnClick="Unnamed1_Click"  Text="ACTUALIZAR STATUS" ID="pd"/></center>            
            </div>
                    <br />
                    <div class="fila col10L">
