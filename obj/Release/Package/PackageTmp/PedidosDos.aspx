<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" enableEventValidation="false" AutoEventWireup="true" CodeBehind="PedidosDos.aspx.cs" Inherits="PanelAdmin.PedidosDos"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card">
        ...
        <ItemTemplate runat="server">
            <div id="listaitem" class="listaitem"> 
                <table style="width: 100%;">
                    <tr>
                        <td style="width:20%"><img src="img/mes.jpg" class="imagenlista"/>  </td>
                        <td style="width:30%"><div id="cajatitulo"><p class="filaitem columnaitem"><h3><asp:label id="titulotiendaweb" runat="server" CssClass="titulolista">Numero dell’ordine <%#Eval("Row") %></asp:label></h3></p></div><div ><p class="filaitem columnaitem"><h4><asp:label id="Label1" runat="server" CssClass="statuslista"> <%#Eval("Status") %></asp:label></h4></p></div></td>
